...
G400_FASTQ_1="G400_PE150_NA12878_WGS_V300046476_L01_1.fq.gz"
G400_FASTQ_2="G400_PE150_NA12878_WGS_V300046476_L01_2.fq.gz"
./scripts/fq2bamfast.sh ${G400_FASTQ_1} ${G400_FASTQ_2} 
./scripts/bammetrics.sh $(basename -s .fq.gz $G400_FASTQ_1).bam

T7_FASTQ_1="E100030471QC960_L01_48_1.fq.gz"
T7_FASTQ_2="E100030471QC960_L01_48_2.fq.gz"
./scripts/fq2bamfast.sh ${T7_FASTQ_1} ${T7_FASTQ_2} 
./scripts/bammetrics.sh $(basename -s .fq.gz $T7_FASTQ_1).bam

# 2. Run bamstats to get number of reads 

# ./scripts/bamstats.sh $(basename -s .fq.gz $G400_FASTQ_1).bam
# ./scripts/bamstats.sh $(basename -s .fq.gz $T7_FASTQ_1).bam
...
# ./scripts/downsample.sh ${T7_FASTQ_2CV} 0.75 
